...
class CountSquares:
    ...
    def count(self, point: List[int]) -> int:
        ...
        return res
#time complexity: O(n) where n is the number of points added to the data structure, O(1) for add and O(n) for count
#space complexity: O(n) where n is the number of points added to the data structure