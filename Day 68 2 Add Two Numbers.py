...
class Solution:
    ...
    def add(self, l1: Optional[ListNode], l2: Optional[ListNode]) -> Optional[ListNode]:
        return self.addTwoNumbers(l1, l2, 0)
...
#space complexity: O(max(m, n)) where m and n are the lengths of the linked lists, O(1) if we don't count the output linked list