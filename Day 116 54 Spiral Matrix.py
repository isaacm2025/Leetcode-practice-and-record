...
class Solution:
    def spiralOrder(self, matrix: List[List[int]]) -> List[int]:
        ...
        dfs(m, n, 0, -1, 0, 1)
        return res
#time complexity: O(mn), where m is the number of rows and n is the number of columns in the input matrix, due to the recursive calls and the loops within them.
